        ...
        <>
          ...
          <div className="container mx-auto max-w-[1300px] py-10 text-white">
            ...
            <div className="mt-12 flex flex-col lg:flex-row justify-center gap-9">
              <form
                className="bg-yellow-light/10 shadow-md rounded-md p-8 w-full max-w-[700px]"
                onSubmit={(e) => {
                  e.preventDefault();
                }}
              >
                ...
                <button
                  type="submit"
                  className="bg-blue-600 hover:bg-blue-700 text-white font-[500] text-sm py-3 px-6 mt-6 rounded"
                  id="addPost"
                  onClick={addPost}
                >
                  Add Post
