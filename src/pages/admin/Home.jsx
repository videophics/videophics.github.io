      ...
      {({ user }) => (
        <>
          ...
          <div className="container py-12 mx-auto max-w-[1300px]">
            ...
            <div className="_admin-account w-full max-w-[450px] mx-auto mt-5 text-gray-800 dark:text-white text-center">
            ...
            <div className="_admin-menu grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-12">
              <NavLink to="/admin/blog">
                <div className="bg-white dark:bg-gray-800 shadow-md rounded-md p-6 hover:shadow-lg transition duration-300 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer select-none">
                  <h2 className="text-gray-700 dark:text-white text-lg font-[500]">
                    My Blog
                  </h2>
