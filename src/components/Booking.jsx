  ...
  return (
    <div className="container mx-auto max-w-[1300px]">
      <div className="text-center">
        ...
        <p className="text-[14px] md:text-[17px] text-gray-500 leading-6 md:leading-7 mb-8">
          Schedule an appointment with us and let's get started on your
          project.
        </p>
        <button
          className="bg-white text-sm md:text-[16px] px-8 py-3 rounded-md bg-gradient-to-l hover:from-gray-100 hover:to-gray-200 active:scale-95 from-gray-800 to-gray-700 text-white"
