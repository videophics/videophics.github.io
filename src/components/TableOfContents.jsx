...
function TableOfContents() {
  ...
  return (
    <div className="text-[17px] leading-7 font-[400] text-gray-900 dark:text-white">
      <ul id="table-of-contents" className="border-l border-[rgba(0,0,0,0.1)] dark:border-[rgba(255,255,255,0.2)] pl-1">
        {toc.map(({ slug, text, level }) => (
          <li key={slug} style={{ paddingLeft: `${(level - 1) * 10}px` }} className="hover:text-gray-500 dark:hover:text-gray-400">
