  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center text-center">
        <p className="text-sm text-gray-500 dark:text-gray-400 leading-6 md:leading-7 uppercase">
          Our Services
        </p>
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-[600] mb-4 text-gray-700 dark:text-white leading-8 md:leading-10 mt-2">
      ...
      <div className="_services-box mt-[4rem] grid md:grid-cols-2 gap-12">
        <div>
          <Link to="/services/branding">
            <div className="main bg-white dark:bg-gray-800 w-full h-full min-h-[300px] flex items-center rounded-lg">
              <div className="p-6">
                <img
                ...
                />
                <h3 className="text-3xl md:text-4xl font-[600] mb-2 text-gray-700 dark:text-white leading-10">
